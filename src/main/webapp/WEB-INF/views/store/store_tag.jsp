...
<jsp:include page="store_tag_script.jsp" />
	...
	<div class="main">
			...
			<ul>
				...
				<li>
					<a href="<%=request.getContextPath()%>/store_slist.do">
						<div class="menu_label">
							<c:if test="${category == 'soju' }">
								<span class="select_label">증류주</span>
								<div class="select_underbar"></div>
							</c:if>
		...
		<div class="header_img_wrap">
			...
			<c:if test="${category == 'soju' }">
				<div class="header_category_cont" style="background-color: rgb(247, 250, 253);">
					<div>
						<div class="category_title">증류주</div>
						<div class="category_cont">소주도 취향 타는 거 알고 계셨어요 ?</div>
					</div>
					<div class="category_logo">
						<img style="width: 80%" alt="logo" src="resources/image/store_soju_logo.png">
					</div>
				</div>
			</c:if>
		</div>
